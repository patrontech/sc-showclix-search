;var EventSearchAPI = function(partnerId) {
    var me = this;
    me.partnerId = partnerId, me.lastSearchPhrase = null, me.lastPage = 0, me.lastXhr = null, me.lastCategory = null;
    ...
    me.bind = function(formSelector, inputSelector, genreSelector, onSuccess) {
        $(formSelector).submit(function(){
            ...
            var genre = genreSelector ? $(genreSelector).val() : null;
            me.search(value, genre, 1, onSuccess);
            return false;
        });
    };
    ...
    me.search = function(phrase, category, page, onSuccess) {
        ...
        var url = "http://api.showclix.com/Event/search?partner=" +
            me.partnerId + "&follow[]=venue&keyword=" + phrase + "&page=" + page;
    ...
    me.more = function(onSuccess) {
        ...
        me.lastPage && me.search(me.lastSearchPhrase, me.lastCategory, me.lastPage + 1, onSuccess);
    };
